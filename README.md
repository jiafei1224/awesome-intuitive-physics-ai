...
This repository contains resources (conference/journal publications, references to datasets) associated the work ["A Survey on Machine Learning Approaches for Modelling Intuitive Physics"](https://arxiv.org/abs/2202.06481) accepted at IJCAI-ECAI (Survey Track) with 18% Acceptance, 2022.

With inspiration frp, the [awesome](https://github.com/sindresorhus/awesome) lists and and [awesome-cogsci](https://github.com/abi-aryan/awesome-cogsci).
...
[![Last Commit](https://img.shields.io/github/last-commit/firojalam/jiafei1224/awesome-intuitive-physics-ai)](https://github.com/jiafei1224/awesome-intuitive-physics-ai/)
